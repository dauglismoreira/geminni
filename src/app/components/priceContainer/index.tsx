...
import LinkWhats from "@/app/components/chatWhatsapp/Link";
    ...
    <div className="price-box">
      ...
      >
        ...
        <div className="contact-buttons">
          <button className="info-button" onClick={() => scrollToSection('localizacao')}>Receber mais informações
          </button>
          <button className="wht-button">
            <LinkWhats phone={configs.data[0].configs[2].description} initialMessage={data?.name_pt_br}>
